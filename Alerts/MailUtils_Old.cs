...
namespace Alerts
{
    ...
    clientCertificate: certificate
            ...
            callGraph(accessToken).GetAwaiter().GetResult();
        ...
        private static async Task callGraph(string accessToken)
        {
            using (var httpClient = new HttpClient())
            {
                ...
                try
                {
                    ...
                    var response = await httpClient.PostAsync(
                        "https://graph.microsoft.com/v1.0/users/atzimpilis@saniikos.com/sendMail",
                        content);
